...
//        guard let shapeLayer = self.layer as? CAEAGLLayer else { return }
//        
...
//    }
    ...
    func compileShaders() {
        ...
        let vertexShader: GLuint = self.compileShader(shaderName: "SimpleVertex", shaderType: GLenum(GL_VERTEX_SHADER))
        let fragmentShader: GLuint = self.compileShader(shaderName: "SimpleFragment", shaderType: GLenum(GL_FRAGMENT_SHADER))
